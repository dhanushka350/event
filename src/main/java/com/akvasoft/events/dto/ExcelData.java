...
public class ExcelData {
    ...
    private String templatic_post_name;
    ...
    public String getTemplatic_post_name() {
        return templatic_post_name;
    }

    public void setTemplatic_post_name(String templatic_post_name) {
        this.templatic_post_name = templatic_post_name;
    }
